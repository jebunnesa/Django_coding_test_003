...
class Survey(models.Model):
    ...
    publish_date = models.DateField(blank=True, null=False, default=now)
...
class Response(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, verbose_name=_("User"), null=True, blank=True)
